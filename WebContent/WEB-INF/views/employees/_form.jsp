...
<label for="group_id">日報承認グループ</label><br />
<select name="group_id">
    <option value="null">-- 上司未選択 --</option>
    <c:forEach var="group" items="${groups}">
            <option value="${group.id}"<c:if test="${employee.group_id == group.id}"> selected</c:if>>${group.name}</option>
    </c:forEach>
</select>
<br /><br />
