...
/**
 * Servlet implementation class GroupIndexServlet
 */
...
public class GroupsIndexServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        long groups_count = (long)em.createNamedQuery("getGroupsCount", Long.class)
                .getSingleResult();

        em.close();

        request.setAttribute("groups", groups);
        request.setAttribute("groups_count", groups_count);
